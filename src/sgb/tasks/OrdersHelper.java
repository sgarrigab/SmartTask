...
class OrdersHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE Cap         (_id LONG PRIMARY KEY, client TEXT, data TEXT, entrega TEXT,state TEXT,quant REAL,value REAL,notes TEXT, dtegrup REAL,dtecomercial REAL,comentari TEXT,entrega_mati TEXT,recullen TEXT,dtepp REAL, agents TEXT,hora TEXT );");
		db.execSQL("CREATE TABLE Linia       (_id INTEGER PRIMARY KEY AUTOINCREMENT, docum LONG,article TEXT,nom TEXT,quant REAL,preu REAL,preunet REAL, tipdte TEXT	,dte REAL,notes TEXT,state TEXT," +
				"codi_obs TEXT,article_regal TEXT,quantitat_regal REAL,preu_regal REAL,canviPreu INTEGER,matricula TEXT, marca TEXT, model TEXT, geo_lng_ini TEXT, geo_lat_ini TEXT, butlleti TEXT, loc_ini TEXT, time_ini TEXT );");
